...
$ordersCustomerAdmin = select_order_admin_controller();
      ...
      <main>
        ...
        <div class="order-data p">
          ...
          <table>
            ...
            <tbody id="ct-loop">
            <?php foreach ( $ordersCustomerAdmin as $orderCustomer ) {
            ?>
              <tr>
                <td>&#35;<?php echo $orderCustomer['invoice_no']?></td>
                <td><?php echo $orderCustomer['customer_firstname']." ".$orderCustomer['customer_lastname'] ?></td>
                <td><?php echo $orderCustomer['order_date'] ?></td>
                <td><?php echo $orderCustomer['order_status'] ?></td>
                <td>
