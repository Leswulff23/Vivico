      ...
      <main>
        ...
        <div class="order-data p">
          ...
          <table>
            ...
            <tbody id="ord-loop">
            <?php foreach ( $ordersAdmin as $orderAdmin ) {
            ?>
              <tr>
                <td>&#35;<?php echo $orderAdmin['invoice_no']; ?></td>
                <td><?php echo $orderAdmin['product_title']; ?></td>
                <td><?php echo $orderAdmin['order_date']; ?></td>
                <td>Pending</td>
                <td>&#8373;<?php echo $orderAdmin['product_price']; ?></td>
                <td>
